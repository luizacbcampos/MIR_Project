...
const dropdownButton1 = d3.select("#dropdown_button_years")
  ...
  .style("background-color", d3.schemeSet3[6])//"#f5b540")

const dropdownButton2 = d3.select("#dropdown_button_years2")
  .attr("id", "button2")
  .style("font-size", "20px")
  .style("background-color",d3.schemeSet3[9])// "#3e72c7")
...
dropdownButton2.on("change", function(d) {
  ...
  const selectedOption = d3.select(this).property("value") // recover the option that has been chosen
